...
def write_emodb_csv(emotions=["sad",'happy'], train_name="train_emo.csv",
...
def write_tess_ravdess_csv(emotions=["sad",'happy'], train_name="train_tess_ravdess.csv",
...
def write_custom_csv(emotions=['sad','happy'], train_name="train_custom.csv", test_name="test_custom.csv",
                    verbose=1):
    """
